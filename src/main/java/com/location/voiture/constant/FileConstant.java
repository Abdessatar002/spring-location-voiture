package com.location.voiture.constant;

public class FileConstant {
    public static final String USER_IMAGE_PATH = "/user/image/";
    public static final String CLIENT_IMAGE_PATH = "/person/image/";
    public static final String VOITURE_DOC_PATH = "/voiture/doc/";

    public static final String JPG_EXTENSION = "jpg";
    public static final String USER_FOLDER = System.getProperty("user.home") + "/supportportal/user/";
    public static final String CLIENT_FOLDER = System.getProperty("user.home") + "/supportportal/person/";
    public static final String VOITURE_FOLDER = System.getProperty("user.home") + "/supportportal/voiture/";
